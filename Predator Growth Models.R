...
ggplot(Data4, aes(DayP, DensP)) +
  ...
  geom_point(data=Data, aes(Day, Count, color=Strain), size=1.5, pch=16) +
  ...
  scale_linetype_manual(values=c("Linear"="solid","Exponential"="dashed","Logistic"="twodash","Mortality"="dotted")) +
